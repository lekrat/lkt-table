import { isFunction, generateRandomString, isUndefined } from "lkt-tools";
import { openBlock, createElementBlock, Fragment, createElementVNode, normalizeClass, createCommentVNode, renderList, renderSlot, createTextVNode, toDisplayString, withDirectives, vShow, defineComponent, resolveComponent, vModelText, createBlock, withCtx } from "vue";
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(Fragment, null, [
    createElementVNode("tr", {
      ...
      _ctx.column && _ctx.column.key && $props.emptyColumns.indexOf(_ctx.column.key) === -1 && (!_ctx.column.colspan || $options.getHorizontalColSpan(_ctx.column, $props.item) > 0) ? (openBlock(true), createElementBlock(Fragment, { key: 3 }, renderList($props.visibleColumns, (column) => {
    ...
    $props.hiddenColumns.length > 0 ? withDirectives((openBlock(), createElementBlock("tr", _hoisted_5$1, [
      createElementVNode("td", { colspan: $props.hiddenColumns }, [
...
const _hoisted_1 = /* @__PURE__ */ createElementVNode("h1", null, "Table", -1);
const _hoisted_2 = /* @__PURE__ */ createElementVNode("li", null, "list start", -1);
const _hoisted_3 = /* @__PURE__ */ createElementVNode("li", null, "list finish", -1);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_lkt_table_row = resolveComponent("lkt-table-row");
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _ctx.hasData ? (openBlock(), createElementBlock("div", {
      ...
      createElementVNode("table", null, [
        createElementVNode("thead", null, [
          createElementVNode("tr", null, [
            _ctx.sortable ? (openBlock(), createElementBlock("th", _hoisted_5)) : createCommentVNode("", true),
            _ctx.HiddenColumns.length > 0 ? (openBlock(), createElementBlock("th", _hoisted_6)) : createCommentVNode("", true),
        ...
        _ctx.sortable ? (openBlock(), createBlock(_component_draggable, {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.Items, (item, i) => {
              return openBlock(), createBlock(_component_lkt_table_row, {
                i,
                item,
          ...
          _: 1
        }, 8, ["modelValue", "group", "move"])) : (openBlock(), createElementBlock("tbody", _hoisted_8, [
          createElementVNode("tr", null, [
            createElementVNode("td", null, toDisplayString(_ctx.Items), 1)
          ]),
          createElementVNode("tr", null, [
            createElementVNode("td", null, toDisplayString(_ctx.Items2), 1)
          ]),
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.Items2, (item, i) => {
            return openBlock(), createElementBlock("tr", {
              key: _ctx.uniqueId + "_" + i
            }, [
              createElementVNode("td", null, toDisplayString(item), 1)
            ]);
          }), 128)),
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.Items, (item, i) => {
    ...
    ], 8, _hoisted_4)) : !!_ctx.$slots["no-items"] ? (openBlock(), createElementBlock("div", _hoisted_9, [
