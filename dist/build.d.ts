...
declare function rl(l: any, e: any, i: any, r?: boolean): {
    key: string;
    label: string;
    sortable: boolean;
    hidden: boolean;
...
declare function il(l: any, e: any, i?: boolean): {
    key: string;
    label: string;
    sortable: boolean;
    hidden: boolean;
...
declare function hl(l: any, e: any, i?: boolean): {
    key: string;
    label: string;
    sortable: boolean;
    hidden: boolean;
...
declare function vl(l: any, e: any, i: any, r?: boolean): {
    key: string;
    label: string;
    sortable: boolean;
    hidden: boolean;
...
declare function pl(l: any, e: any, i?: boolean): {
    key: string;
    label: string;
    sortable: boolean;
    hidden: boolean;
...
export { U as LktTableColumn, rl as createActionColumn, cl as createCheckColumn, il as createColumn, ml as createEmailColumn, hl as createHiddenColumn, ul as createLinkColumn, vl as createSelectColumn, pl as createSwitchColumn, fl as createTelColumn, dl as createTextColumn, yl as default, gl as setTableCreateButtonSlot, bl as setTableDropButtonSlot, kl as setTableNavButtonSlot };
