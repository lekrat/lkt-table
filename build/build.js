import { reactive as U, defineComponent as ee, ref as S, watch as M, computed as c, resolveComponent as K, unref as C, openBlock as n, createBlock as w, withCtx as H, createTextVNode as re, toDisplayString as _, createElementBlock as s, mergeProps as je, Fragment as E, withModifiers as Xe, resolveDynamicComponent as x, createCommentVNode as v, normalizeClass as Z, createElementVNode as L, createVNode as ne, renderList as W, renderSlot as F, withDirectives as ae, vShow as oe, useSlots as Tt, onMounted as $t, nextTick as ze, createSlots as Ge, normalizeProps as me } from "vue";
...
const Rl = (t) => U(new N(t)), Ml = (t, r, i, a = !0) => U(new N({ key: t, label: r, sortable: a, type: R.Link, link: i })), Ll = (t, r, i, a = !0) => U(new N({ key: t, label: r, sortable: a, type: R.Action, action: i })), Nl = (t, r, i = !0) => U(new N({ key: t, label: r, type: R.Text, sortable: i })), Fl = (t, r, i = !0) => U(new N({ key: t, label: r, type: R.Number, sortable: i })), Ul = (t, r, i = !0) => U(new N({ key: t, label: r, type: R.Number, sortable: i })), Al = (t, r, i = !0) => U(new N({ key: t, label: r, type: R.Email, sortable: i })), Pl = (t, r, i = !0) => U(new N({ key: t, label: r, type: R.Tel, sortable: i })), Wl = (t, r, i = !0) => U(new N({ key: t, label: r, type: R.Check, sortable: i })), Hl = (t, r, i = !0) => U(new N({ key: t, label: r, type: R.Switch, sortable: i })), Kl = (t, r, i, a = !0) => U(new N({ key: t, label: r, type: R.Select, sortable: a })), ql = (t, r, i = !0) => U(new N({ key: t, label: r, type: R.File, sortable: i })), jl = (t, r, i = !0) => U(new N({ key: t, label: r, sortable: i, hidden: !0 })), Oe = (t, r, i, a) => {
  ...
  if (t.formatter && typeof t.formatter == "function") {
    ...
    return u.startsWith("__:") ? pe(u.substring(3)) : u;
  }
  return r[t.key];
}, Nt = (t, r, i) => {
  ...
  setup(t, { emit: r }) {
    ...
    return (m, o) => {
      ...
      return m.column.type === C(R).Link ? (n(), w(p, {
        key: 0,
        to: m.column.getHref(u.value)
      }, {
        default: H(() => [
          re(_(C(ue)(m.column, u.value, m.i)), 1)
        ]),
        _: 1
      }, 8, ["to"])) : m.column.type === C(R).Action ? (n(), s("a", {
        key: 1,
        href: "#",
        onClick: o[0] || (o[0] = (k) => m.column.doAction(u.value))
      }, _(C(ue)(m.column, u.value, m.i)), 1)) : m.column.type !== "" && m.hasInlineEditPerm ? (n(), w(b, je({ key: 2 }, m.column.field, {
        icon: d.value,
        download: q.value,
        type: P.value,
        ...
        options: G.value,
        "model-value": l.value
      }), null, 16, ["icon", "download", "type", "slot-data", "label", "modal-key", "modal-data", "options", "model-value"])) : (n(), s(E, { key: 4 }, [
        re(_(C(ue)(m.column, u.value, m.i, m.columns)), 1)
      ], 64));
    };
  }
}), z = class z {
...
const Wt = /* @__PURE__ */ ee({
  ...
  emits: ["click"],
  setup(t, { emit: r }) {
    const i = r, a = c(() => D.dropButtonSlot !== ""), u = c(() => D.dropButtonSlot);
    return (l, y) => {
      ...
      return n(), w(V, {
        ...
        default: H(() => [
          a.value ? (n(), w(x(u.value), { key: 0 })) : v("", !0)
        ]),
        _: 1
  ...
  emits: ["click"],
  setup(t, { emit: r }) {
    const i = r, a = c(() => D.editButtonSlot !== ""), u = c(() => D.editButtonSlot);
    return (l, y) => {
      const V = K("lkt-button");
      return n(), w(V, {
        palette: "table-delete",
  ...
  setup(t, { emit: r }) {
    const i = r, a = t, u = S(a.modelValue), l = S(a.editLink);
    for (let o in u.value) l.value = Ye(l.value, ":" + o, u.value[o]);
    ...
    return M(() => a.modelValue, (o) => u.value = o), M(u, (o) => {
      ...
      return n(), s("tr", {
        ...
        o.addNavigation && o.editModeEnabled ? (n(), s("td", jt, [
          L("div", zt, [
            ne(b, {
              ...
              default: H(() => [
                T.value ? (n(), w(x(d.value), {
                  key: 0,
                  direction: "up"
                })) : (n(), s(E, { key: 1 }, [
                  p[2] || (p[2] = L("i", { class: "" }, null, -1)),
                  p[3] || (p[3] = re(" UP "))
                ], 64))
              ]),
              _: 1
        ...
        (n(!0), s(E, null, W(o.visibleColumns, (k) => (n(), s(E, null, [
          C(Ut)(k, o.emptyColumns, u.value) ? (n(), s("td", {
            key: "td" + o.i,
            "data-column": k.key,
            colspan: C(Ee)(k, u.value),
            title: C(ue)(k, u.value, o.i, o.visibleColumns),
            onClick: (J) => y(J, u.value)
          }, [
            o.$slots[k.key] && C(Ft)(k, u.value) ? F(o.$slots, k.key, {
              key: 0,
              value: u.value[k.key],
              item: u.value,
              column: k,
              ...
              key: 1,
              modelValue: u.value,
              "onUpdate:modelValue": p[1] || (p[1] = (J) => u.value = J),
              column: k,
        ...
        o.canDrop && o.editModeEnabled ? (n(), s("td", Jt, [
          ne(Wt, {
        ...
        o.canEdit && o.editModeEnabled ? (n(), s("td", Ot, [
          ne(Ht, {
            "resource-data": u.value,
            text: o.editText,
            icon: o.editIcon,
  ...
  setup(t, { emit: r }) {
    ...
    return M(() => a.modelValue, (y) => u.value = y), M(u, () => i("update:modelValue", u.value)), (y, V) => ae((n(), s("tr", Xt, [
      L("td", { colspan: y.hiddenColumnsColSpan }, [
        L("table", null, [
          L("tr", null, [
            (n(!0), s(E, null, W(y.hiddenColumns, (g) => (n(), s("th", {
              "data-column": g.key
            }, [
              L("div", null, _(g.label), 1)
            ], 8, Zt))), 256))
          ]),
          L("tr", { "data-i": y.i }, [
  ...
  emits: ["click"],
  setup(t, { emit: r }) {
    const i = r, a = c(() => D.createButtonSlot !== ""), u = c(() => D.createButtonSlot);
    return (l, y) => {
      const V = K("lkt-button");
      return n(), w(V, {
  ...
  emits: ["click"],
  setup(t, { emit: r }) {
    const i = r, a = t, u = c(() => Nt(a.column, a.amountOfColumns, a.items)), l = c(() => a.column.sortable === !0), y = c(() => l.value && a.sortBy === a.column.key ? a.sortDirection : ""), V = c(() => a.column.label.startsWith("__:") ? pe(a.column.label.substring(3)) : a.column.label), g = () => i("click", a.column);
    return (T, d) => (n(), s("th", {
...
const al = ["id"], ol = { class: "lkt-table-page-buttons" }, nl = { key: 1 }, ul = { class: "switch-edition-mode" }, rl = {
  ...
  setup(t, { expose: r, emit: i }) {
    const a = i, u = Tt(), l = t, y = {}, V = S(typeof l.sorter == "function" ? l.sorter : Oe), g = S(At(l.columns)), T = S(fe.Asc), d = S(l.modelValue), q = S(y), G = S(null), P = S(l.columns), m = S(l.page), o = S(l.loading), p = S(!1), b = S(l.perms), k = S(null), J = S(null), ve = S({}), le = S(new Mt({ items: d.value }, l.dataStateConfig)), $ = S(l.editMode), ie = S(0);
    M(o, (e) => a("update:loading", e)), M(m, (e) => a("page", e));
    const ye = S(l.type);
    ...
    const _e = (e) => {
      ...
      let e = [];
      for (let f in u) ut.value.indexOf(f) !== -1 && e.push(f);
      return e;
    ...
    }, qe = c(() => typeof l.createEnabledValidator == "function" ? l.createEnabledValidator({ items: d.value }) : !0), ge = c(() => Le.value || yt.value && $.value), Ce = (e, f) => typeof l.itemDisplayChecker == "function" ? l.itemDisplayChecker(e) : !0;
    $t(() => {
      ...
      e ? Ke() : Dt();
    }), M(() => l.perms, (e) => b.value = e), M(b, (e) => a("update:perms", e)), M(() => l.editMode, (e) => $.value = e), M(() => l.columns, (e) => P.value = e, { deep: !0 }), M(() => l.modelValue, (e) => d.value = e, { deep: !0 }), M(d, (e) => {
    ...
    return (e, f) => {
      ...
      return n(), s("section", {
        ...
        Ie.value || C(u).title ? (n(), s("header", {
          key: 0,
          class: Z(e.headerClass)
        }, [
          Ie.value ? (n(), w(x(ct.value), { key: 0 }, {
            default: H(() => [
              e.titleIcon ? (n(), s("i", {
                key: 0,
                class: Z(e.titleIcon)
          ...
          C(u).title ? F(e.$slots, "title", { key: 1 }) : v("", !0)
        ], 2)) : v("", !0),
        (n(), w(x(mt.value), {
          ...
          default: H(() => [
            ae(L("div", ol, [
              ae(ne(I, {
                ...
                default: H(() => [
                  ...
                  }) : (n(), s("span", nl, _(ft.value), 1))
                ]),
                _: 3
              }, 8, ["icon", "disabled", "confirm-modal", "confirm-data", "resource", "resource-data"]), [
                [oe, Re.value]
              ]),
              ge.value && d.value.length >= e.requiredItemsForTopCreate ? (n(), w(Qe, {
                key: 0,
            ...
            C(u).buttons ? (n(), s("div", rl, [
              F(e.$slots, "buttons")
            ])) : v("", !0),
            p.value && C(u).filters ? (n(), s("div", il, [
              F(e.$slots, "filters", {
                items: d.value,
                isLoading: o.value
              })
              ...
              ye.value === C(X).Table ? (n(), s("table", sl, [
                L("thead", null, [
                  L("tr", null, [
                    ...
                    (n(!0), s(E, null, W(ke.value, (B) => (n(), s(E, null, [
                      Be.value.indexOf(B.key) === -1 ? (n(), w(ll, {
                        key: 0,
                        column: B,
                        "sort-by": g.value,
                    ...
                    Me.value && se.value && $.value ? (n(), s("th", vl)) : v("", !0)
                  ])
                ]),
                L("tbody", {
                  ref_key: "tableBody",
                  ...
                  (n(!0), s(E, null, W(d.value, (B, h) => ae((n(), w(Qt, {
                    ...
                    "can-edit": Me.value && se.value && $.value,
                  ...
                  we.value.length > 0 ? (n(!0), s(E, { key: 0 }, W(d.value, (B, h) => (n(), w(el, {
                    modelValue: d.value[h],
                    "onUpdate:modelValue": (j) => d.value[h] = j,
                    key: Ve(B, h, !0),
                    i: h,
                ...
                (n(!0), s(E, null, W(d.value, (B, h) => (n(), s(E, null, [
                  Ce(B) ? (n(), s("div", {
            ...
            !o.value && d.value.length === 0 ? (n(), s("div", Cl, [
              C(u).empty ? F(e.$slots, "empty", { key: 0 }) : Vt.value ? (n(), w(x(Et.value), {
                key: 1,
                message: e.noResultsText
              }, null, 8, ["message"])) : e.noResultsText ? (n(), s(E, { key: 2 }, [
                re(_(e.noResultsText), 1)
              ], 64)) : v("", !0)
            ])) : v("", !0),
            ge.value || C(u).bottomButtons ? (n(), s("div", Sl, [
              ge.value && d.value.length >= e.requiredItemsForBottomCreate ? (n(), w(Qe, {
                key: 0,
                disabled: !qe.value || e.createDisabled,
                text: e.createText,
                icon: e.createIcon,
